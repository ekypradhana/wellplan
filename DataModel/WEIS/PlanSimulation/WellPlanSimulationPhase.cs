...
namespace ECIS.Client.WEIS
{
    ...
    public class WellPlanSimulationPhase
    {
        public WellPlanSimulationPhase()
        {
        }
        [BsonIgnore]
        ...
        private DateRange _SimulationSchedule;
        ...
        public DateRange SimulationSchedule
        {
            get
            {
                if (_SimulationSchedule == null) _SimulationSchedule = new DateRange();
                return _SimulationSchedule;
            }
            set { _SimulationSchedule = value; }
        }
        ...
        private WellDrillData _simulation, _op, _afe, _le, _lwe, _tq, _actual, _m1, _m2, _m3, _calcop;

        public WellDrillData Simulation 
        {
            get 
            {
                if (_simulation == null) _simulation = new WellDrillData();
                return _simulation;
            }
            set 
            {
